/**
 * GroupCard is a component that displays a group card.
 *
 * @returns {JSX.Element} GroupCard component
 */
export default function GroupCard(): JSX.Element {
  return (
